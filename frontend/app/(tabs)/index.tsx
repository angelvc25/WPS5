      ...
      >
        ...
        {!isLibraryFocused && (
          ...
          `}</style>
            ...
            <Animated.View key={`welcome-widgets-${activeIndex}`} entering={FadeInDown.duration(400).delay(60)} style={widgetContainerStyle}>
            ...
            {canPlay && (
              ...
              >
                ...
                {/* Music Player Card — visible solo en items de tipo media */}
